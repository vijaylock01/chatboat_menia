				...
				@if (config('settings.image_vendor') == 'stable_diffusion' || config('settings.image_vendor') == 'both')
					<select id="resolution" name="resolution_sd" class="form-select sd-feature hide-all">	
						@if ($sd_model == 'none')
							...
							@elseif (config('settings.image_stable_diffusion_engine') == 'sd3-medium' || config('settings.image_stable_diffusion_engine') == 'sd3-large' || config('settings.image_stable_diffusion_engine') == 'sd3-large-turbo' || config('settings.image_stable_diffusion_engine') == 'core' || config('settings.image_stable_diffusion_engine') == 'ultra')
