	...
	<div class="page-header mt-5-7 justify-content-center">
		<div class="page-leftheader text-center">
			...
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item"><a href="{{ url('#') }}"> {{ __('View Document') }}</a></li>
	...
	<div class="row justify-content-center">
		<div class="col-lg-9 col-md-12 col-sm-12">
			<div class="card border-0 pl-6 pr-6">
				<div class="card-body">	
					<form id="publish-form" action="{{ route('user.documents.publish.wordpress') }}" method="post" enctype="multipart/form-data" class="mt-24"> 		
						@csrf	
							...
							<div class="col-md-11 col-sm-12 mb-4">								
								<div class="input-box mb-2">								
									<div class="form-group">
										...
										<input type="text" class="form-control @error('title') is-danger @enderror" id="title" name="title" value="{{ $id->title }}" required>
									</div> 
								</div> 
							</div>
							<div class="col-md-11 col-sm-12 mb-4">								
								<div class="input-box mb-2">								
									<div class="form-group">
										<h6 class="fs-11 mb-2 font-weight-semibold">{{ __('Slug') }} <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>							    
										<input type="text" class="form-control @error('slug') is-danger @enderror" id="slug" name="slug" required>
									</div> 
								</div> 
							</div>
						</div>
						...
						<div class="border-0 text-center mb-5 mt-5">
							<button type="submit" class="btn btn-primary ripple pl-8 pr-8">{{ __('Publish') }}</button>
						</div>
					</form>
				</div>
			</div>
...
<script type="text/javascript">
	...
	$(function () {
		...
		$(document).ready(function() {
			...
			let pop = slugify('{{ $id->title }}');

			document.getElementById('slug').value = pop;
		});
