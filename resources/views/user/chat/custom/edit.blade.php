		...
		<div class="col-lg-9 col-md-12 col-sm-12">
			<div class="card border-0">	
				<div class="card-header">
					...
					<a href="{{ route('user.chat.custom') }}" class="btn btn-cancel ripple" style="margin-left: auto">{{ __('Back to AI Chats') }}</a>
				</div>			
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-12">
								<div class="input-box">
									...
									<a href="{{ route('user.chat.custom.files') }}" class="text-right fs-12 font-weight-semibold">{{ __('View All Included Files to this Chatbot') }}</a>
								</div>
							</div>
						</div>
