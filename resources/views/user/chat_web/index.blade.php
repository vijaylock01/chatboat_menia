...
<script type="text/javascript">
	...
	$(document).on('click', ".chat-sidebar-message", function (e) { 
		...
		$.ajax({
			...
			method: 'POST',
			url: '<?php echo env('BASE_URL_PUBLIC');?>user/chat/web/conversation',
		...
		Swal.fire({
			...
			if (result.value) {
				...
				$.ajax({
					headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
					method: 'post',
					url: '<?php echo env('BASE_URL_PUBLIC');?>user/chat/web/rename',
					data: formData,
					processData: false,
					contentType: false,
					success: function (data) {
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
				...
				$.ajax({
					headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
					method: 'post',
					url: '<?php echo env('BASE_URL_PUBLIC');?>user/chat/web/delete',
					data: formData,
					processData: false,
					contentType: false,
					success: function (data) {
	...
	function analyze(url) {
		...
		$.ajax({
			headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
			method: 'post',
			url: '<?php echo env('BASE_URL_PUBLIC');?>user/chat/web/embedding',
			data: formData,
			processData: false,
			contentType: false,
			success: function (data) {
	...
	function checkBalance(task, message) {
		...
		$.ajax({
			headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
			method: 'post',
			url: '<?php echo env('BASE_URL_PUBLIC');?>user/chat/web/check-balance',
			data: formData,
			processData: false,
			contentType: false,
			success: function (data) {
	...
	function createConversationBox(new_chat_id) {
		...
		$.ajax({
			headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
			method: 'post',
			url: '<?php echo env('BASE_URL_PUBLIC');?>user/chat/web/metainfo',
			data: formData,
			processData: false,
			contentType: false,
			success: function (data) {
	...
	function calculateCredits() {
		...
		$.ajax({
			headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
			method: 'post',
			url: '<?php echo env('BASE_URL_PUBLIC');?>user/chat/csv/credits',
			data: 'credit',
			processData: false,
			contentType: false,
			success: function (data) {
