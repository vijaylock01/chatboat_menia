						...
						<div class="card border-0 special-shadow mb-7">							
							<div class="card-body">
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-sm-12">									
										<div class="input-box">								
											<h6>{{ __('Default Main Theme') }}</h6>
											<select id="theme" name="theme" class="form-select">	
												<option value="light" {{ (config('settings.default_theme') == 'light') ? 'selected' : '' }}>{{ __('Light Theme') }}</option>
												<option value="dark" {{ (config('settings.default_theme') == 'dark') ? 'selected' : '' }}>{{ __('Dark Theme') }}</option>																		
											</select> 
										</div> 
									</div>
								</div>
