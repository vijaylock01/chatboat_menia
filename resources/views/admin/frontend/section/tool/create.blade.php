...
@section('page-header')
	...
	<div class="page-header mt-5-7 justify-content-center">
		<div class="page-leftheader text-center">
			<h4 class="page-title mb-0">{{ __('Create Tool') }}</h4>
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="{{url('#')}}"> {{ __('Create Tool') }}</a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
		...
		<div class="col-lg-8 col-md-8 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-header">
					<h3 class="card-title">{{ __('Create Tool') }}</h3>
				</div>
				<div class="card-body pt-5">									
					<form id="" action="{{ route('admin.settings.tool.store') }}" method="POST" enctype="multipart/form-data">
						@csrf
						...
						<div class="row mt-2">	
							...
							<div class="col-md-6 col-sm-12">							
								<div class="input-box">								
									...
									<div class="form-group">							    
										<input type="text" class="form-control" id="subname" name="subname" value="{{ old('subname') }}" required>
									</div> 
									@error('subname')
									...
									<div class="col-md-12 col-sm-12 mt-2 mb-4 pl-0">
										<div class="form-group">
										  	<label class="custom-switch">
												<input type="checkbox" name="activate" class="custom-switch-input">
							...
							<div class="col-lg-12 col-md-12 col-sm-12">							
								<div class="input-box">								
									...
									<div class="form-group">							    
										<input type="text" class="form-control" id="footer" name="footer" value="{{ old('footer') }}">
									</div> 
									@error('footer')
