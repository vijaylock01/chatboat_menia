...
@section('page-header')
	...
	<div class="page-header mt-5-7 justify-content-center"> 
		<div class="page-leftheader text-center">
			<h4 class="page-title mb-0">{{ __('New Image Prompt') }}</h4>
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item active" aria-current="page"><a href="#"> {{ __('New Image Prompt') }}</a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
					...
					<form action="{{ route('admin.davinci.image.prompt.store') }}" method="POST" enctype="multipart/form-data">
						...
						<div class="modal-footer d-inline">
						  <div class="row text-center">
							<div class="col-md-12">
								<a href="{{ route('admin.davinci.image.prompt') }}" class="btn btn-cancel mr-2 pl-7 pr-7">{{ __('Return') }}</a>
