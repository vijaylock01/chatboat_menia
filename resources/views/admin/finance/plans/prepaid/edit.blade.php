		...
		<div class="@if ($type == 'Regular License') col-md-10 @else col-lg-8 col-md-8 @endif col-sm-12">
			<div class="card border-0">
				<div class="card-header border-0 pb-0">
					<h6 class="card-title fs-12 text-muted">{{ __('Edit Prepaid Plan') }}</h6>
				</div>
									...
									<div class="row">								
										...
										<div class="col-lg-6 col-md-12 col-sm-12">							
											<div class="input-box">								
												...
												<div class="form-group">							    
													<input type="number" class="form-control" id="gpt_4o_mini" min=0 name="gpt_4o_mini" value="{{ $id->gpt_4o_mini_credits_prepaid }}">
													<span class="text-muted fs-10">{{ __('For AI Templates and AI Chat features') }}</span>
												</div> 
											</div> 						
										</div>
