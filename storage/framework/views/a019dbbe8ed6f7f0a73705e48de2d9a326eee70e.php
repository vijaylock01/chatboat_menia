						...
						<div class="col-sm-12">
							<div class="text-center pb-4">                       
								<label class="custom-switch">
									<input type="checkbox" class="custom-switch-input" name="newsletter" id="newsletter" onchange="toggleEmail()" <?php if(auth()->user()->email_opt_in): ?> checked <?php endif; ?>>
									<span class="custom-switch-indicator"></span>
									<span class="custom-switch-description fs-12 text-muted"><?php echo e(__('Receive Newsletters via Email')); ?></span>
								</label>   
							</div>
						</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="card mb-5 border-0">
						<div class="card-header d-inline border-0">
							...
							<?php if(is_null($user_subscription)): ?>
								<div>
						...
						<div class="card-body">
							<div class="mb-3">
								...
								<span class="fs-12 text-muted"><?php echo e(__('Total words available via subscription plan')); ?>: <?php if(auth()->user()->gpt_3_turbo_credits == -1): ?> <?php echo e(__('Unlimited')); ?> <?php else: ?> <?php echo e(number_format(auth()->user()->gpt_3_turbo_credits)); ?> <?php endif; ?>.</span> <span class="fs-12 text-muted"><?php echo e(__('Total prepaid words available ')); ?>: <?php echo e(number_format(auth()->user()->gpt_3_turbo_credits_prepaid)); ?>. </span>
								<?php else: ?>
									<span class="fs-12 text-muted"><?php echo e(__('Total words available via subscription plan')); ?> <?php echo e(number_format(auth()->user()->gpt_3_turbo_credits)); ?>. </span> <span class="fs-12 text-muted"><?php echo e(__('Total prepaid words available')); ?> <?php echo e(number_format(auth()->user()->gpt_3_turbo_credits_prepaid)); ?>. </span>
								<?php endif; ?>
							</div>
	...
	<script>
		...
		function toggleEmail() {
			...
			$.ajax({
				...
				success: function (data) {
					if (data['status'] == 200) {
						toastr.success('<?php echo e(__('Email newsletter status has been updated successfully')); ?>');								
					} else {
						toastr.error('<?php echo e(__('There was an issue updating email newsletter status')); ?>');
					}      
				},
				error: function(data) {
					toastr.error('<?php echo e(__('There was an issue updating email newsletter status')); ?>');
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\vijay\project\xampp\htdocs\chatboat_menia\resources\views/user/profile/index.blade.php ENDPATH**/ ?>